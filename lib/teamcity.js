...
if (typeof window === 'undefined') {
  ...
  logError = function(msg) { process.stderr.write(msg + '\n') }
}
...
function Teamcity(runner) {
  ...
  runner.on('fail', function(test, err) {
    logError('##teamcity[testFailed name=\'' + escape(test.title) + '\' message=\'' + escape(err.message) + '\' captureStandardOutput=\'true\' details=\'' + escape(err.stack) + '\']')
  })
